...
async function init(){
    ...
    model = await tf.loadLayersModel('http://127.0.0.1:5500/sample_project_tfjs/starter/tfjs_model/model.json');
    isModelLoaded = true;
 
    //Memanggil word_index
    const word_indexjson = await fetch('http://127.0.0.1:5500/sample_project_tfjs/starter/word_index.json');
